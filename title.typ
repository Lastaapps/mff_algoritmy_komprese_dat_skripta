...
#align(center)[
  #v(2cm)
  #text(size: 2.5em, weight: "bold")[Data Compression Algorithms]
  #v(1.5cm)
  ...
  #v(0.5cm)
  #text(size: 1.2em)[First iteration generated by Gemini 2.5 Pro]

  #v(6cm)

  #text(size: 1.1em)[
    #link(
      "https://github.com/Lastaapps/mff_algoritmy_komprese_dat_skripta",
